/**
 * JavaScript detector - finds console.log and related logging statements
 */
...
export class JavaScriptDetector implements IDetector {
  ...
  buildPatterns(config: CleanerConfig): DetectorPattern[] {
    ...
    // Build list of enabled console methods
    ...
    if (enabledMethods.length > 0) {
      patterns.push({
        ...
        description: 'JavaScript console.* statements',
        mode: 'singleLine',
        priority: 10,
